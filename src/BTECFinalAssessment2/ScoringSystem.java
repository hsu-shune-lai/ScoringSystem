...
public class ScoringSystem {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            int option = getIntInput("You can enter integer only, please enter again");
            ...
            switch (option) {
                case 1:
                    ...
                    int teamNo = getIntInput("You can enter integer only, please enter again");
                    ...
                    if (teamNo == 0) {
                        ...
                        ArrayList<Integer> winner_team = new ArrayList<Integer>();
                        ...
                        System.out.print("Congratulation! Teams ");
                        for (int i = 0; i < winner_team.size(); i++) {
                            System.out.print(teamName[winner_team.get(i)] + ", ");
                        }
                        System.out.println("have won with score: " + winner_team_score);
                        System.out.println(
                                "----------------------------------------------------------------------------\n");
                        System.out.println("********************");
                    }
                ...
                case 2:
                    ...
                    if (PartNo == 0) {
                        ...
                        ArrayList<Integer> pwinner_team = new ArrayList<Integer>();
                        for (int i = 0; i < PartNo; i++) {
                        ...
                        System.out.print("Congratulation! Individual participant ");
                        for (int i = 0; i < pwinner_team.size(); i++) {
                            System.out.print(PartName[pwinner_team.get(i)] + ", ");
                        }
                        System.out.println("have won with score: " + pwinner_score);
                        System.out.println(
                                "----------------------------------------------------------------------------");
                        System.out.println("********************");
                    }
                ...
                case 3:
                    ...
                    int SpecTeamNo = getIntInput("You can enter integer only, please enter again");
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        for (int i = 0; i < SpecTeamNo; i++) {
                            ...
                            SpecTeamName[i] = scan.nextLine();

                            for (int a = 0; a < 1; a++) {
                                System.out.println("Enter rank of the team: "+SpecTeamName[i]+" on the event: "+STevent[0]);
                                sTeamRank = getIntInput("You can enter integer only, please enter again");
                                int stRank = 0;
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        ArrayList<Integer> Swinner_team = new ArrayList<Integer>();
                        ...
                        System.out.print("Congratulation! Special Teams ");
                        for (int i = 0; i < Swinner_team.size(); i++) {
                            System.out.print(SpecTeamName[Swinner_team.get(i)] + ", ");
                        }
                        System.out.println("have won with score: " + Swinner_team_score);
                ...
                case 4:
                    ...
                    SpecPartNo = getIntInput("You can enter integer only, please enter again");
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        for (int i = 0; i < SpecPartNo; i++) {
                            System.out.println("Enter Name of individual " + (i + 1));
                            SpecPartName[i] = scan.nextLine();

                            for (int a = 0; a < 1; a++) {
                                System.out.println("Enter rank of the individual "+SpecPartName[i]+" on the event:"+SPevent[0]);
                                int sPartRank = getIntInput("You can enter integer only, please enter again");
                                int spRank = 0;
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        ArrayList<Integer> spwinner_name = new ArrayList<Integer>();
                        for (int i = 0; i < SpecPartNo; i++) {
                        ...
                        System.out.println("----------------------------------------------------------------------------");
                        System.out.print("Congratulation!! Teams ");
                        for (int i = 0; i < spwinner_name.size(); i++) {
                            System.out.print(SpecPartName[spwinner_name.get(i)] + ", ");
                        }
                        System.out.println("have won with score: " + spwinner_score);
                        System.out.println(
                                "----------------------------------------------------------------------------");
                        System.out.println("********************");
